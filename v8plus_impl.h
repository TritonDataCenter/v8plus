...
#define	_USE_ISOLATE(i)		i,
#define	_USE_ISOLATE_ONLY(i)	i
#define	ISOLATE_OR_UNUSED_VOID(argname)	v8::Isolate *argname
...
#define	DECLARE_ISOLATE_FROM_ARGS(vname, args)
#define	DECLARE_ISOLATE_FROM_CURRENT(vname)
#define	_USE_ISOLATE(i)
#define	_USE_ISOLATE_ONLY(i)
#define	ISOLATE_OR_UNUSED_VOID(argname)	void *argname __UNUSED
...
#define	V8_EXTERNAL_NEW(isolate, ptr)					\
	v8::External::New(_USE_ISOLATE(isolate) reinterpret_cast<void*>(ptr))
#define	V8_FUNCTMPL_NEW(isolate, funcp, externalp)			\
	v8::FunctionTemplate::New(_USE_ISOLATE(isolate) funcp, externalp)
#define	V8_UNDEFINED(isolate)						\
	v8::Undefined(_USE_ISOLATE_ONLY(isolate))
#define	V8_NULL(isolate)						\
	v8::Null(_USE_ISOLATE_ONLY(isolate))
#define	V8_ARRAY_NEW(isolate)						\
	v8::Array::New(_USE_ISOLATE_ONLY(isolate))
#define	V8_OBJECT_NEW(isolate)						\
	v8::Object::New(_USE_ISOLATE_ONLY(isolate))
...
extern v8::Handle<v8::Value> nvpair_to_v8_Value(ISOLATE_OR_UNUSED_VOID(_),
    const nvpair_t *);
